...
precompile_asset() {
    ...
    assetCPath="./c/$assetName.c"
    assetHPath="./h/$assetName.h"
    assetOPath="./o/$assetName.o"
    ...
    ../musl/bin/gcc -Wall -Wextra -Werror -static -s -O3 -c $assetCPath -o $assetOPath
}

precompile_asset ./mysteryimage.raw
precompile_asset ./mysterysong.raw